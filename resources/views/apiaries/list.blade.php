...
<script>
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '.edit-hives', function () {
            ...
            $.get('/app/apiaries/' + hives_id + '/edit', function (data) {
                $('#name-error').hide();
                $('#email-error').hide();
        ...
        $('body').on('click', '#delete-user', function () {
            ...
            $.ajax({
                type: "get",
                url: SITEURL + "/app/apiaries/delete/" + hives_id,
        ...
        $("#userForm").validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    ...
                    url: SITEURL + "/app/apiaries/store",
                    type: "POST",
                    dataType: 'json',
                    success: function (data) {
