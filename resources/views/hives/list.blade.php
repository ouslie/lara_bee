                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="userForm" name="userForm" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">Nb de cadres</label>
                                                <div class="col-sm-12">
                                                    <input type="number" class="form-control" id="frame" name="frame"
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '.edit-hives', function () {
            ...
            $.get('/app/hives/' + hives_id + '/edit', function (data) {
                $('#name-error').hide();
                $('#email-error').hide();
        ...
        $('body').on('click', '#delete-user', function () {
            ...
            $.ajax({
                type: "get",
                url: SITEURL + "/app/hives/delete/" + hives_id,
